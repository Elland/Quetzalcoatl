...
public class OutgoingSignalMessage: SignalMessage {
    ...
    public init(recipientId: String, senderId: String, chatId: String, body: String, groupMessageType: GroupMetaMessageType = .none, groupMembers: [String]? = nil, store: SignalServiceStore?) {
