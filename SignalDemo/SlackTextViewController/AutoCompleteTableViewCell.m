...
- (void)prepareForReuse
{
    ...
    CGFloat pointSize = [AutoCompleteTableViewCell defaultFontSize];
...
- (UILabel *)titleLabel
{
    if (!_titleLabel) {
        ...
        _titleLabel.font = [UIFont boldSystemFontOfSize:[AutoCompleteTableViewCell defaultFontSize]];
    }
    return _titleLabel;
}
...
- (UILabel *)bodyLabel
{
    if (!_bodyLabel) {
        ...
        _bodyLabel.font = [UIFont systemFontOfSize:[AutoCompleteTableViewCell defaultFontSize]];
    }
    return _bodyLabel;
}
